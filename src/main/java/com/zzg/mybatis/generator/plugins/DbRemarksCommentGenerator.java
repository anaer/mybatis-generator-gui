...
public class DbRemarksCommentGenerator implements CommentGenerator {
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable,
        ...
        if (isAnnotations) {
            ...
            Optional<GeneratedKey> optional = introspectedTable.getTableConfiguration()
                    .getGeneratedKey();
            String runtimeSqlStatement = optional.isPresent()
                    ? optional.get().getRuntimeSqlStatement()
                    : null;
